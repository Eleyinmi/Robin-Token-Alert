"""
Robin Token Alert — Flask app for Vercel (@vercel/python builder).

Routes:
  GET/POST /api/scan  — scheduled scan (called by GitHub Actions every 2 min)
  GET/POST /api/bot   — Telegram webhook command handler
"""
